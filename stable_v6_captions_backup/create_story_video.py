...
# -----------------------------
# 🔥 SIMPLE CAPTIONS (NO IMAGEMAGICK)
# -----------------------------
...
for i in range(0, len(words), words_per_caption):
    text = " ".join(words[i:i + words_per_caption])

    start_time = (i / len(words)) * video.duration
    duration = (words_per_caption / len(words)) * video.duration
